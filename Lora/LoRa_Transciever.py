...
class LoRa_Transciever(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "LoRa_Transciever")
        ...
        self.lora_sdr_modulate_0 = lora_sdr.modulate(7, 500000, 125000, [18], (int(20*2**7*samp_rate/125000)),8)
        self.lora_sdr_interleaver_0 = lora_sdr.interleaver(2, 7, 2, 125000)
        self.lora_sdr_header_decoder_0 = lora_sdr.header_decoder(False, 3, 255, False, 2, False)
        self.lora_sdr_header_0 = lora_sdr.header(False, True, 2)
        self.lora_sdr_hamming_enc_0 = lora_sdr.hamming_enc(2, 7)
        ...
        self.lora_sdr_frame_sync_0 = lora_sdr.frame_sync(center_freq, 125000, 7, False, [18], 4,8)
        ...
        self.blocks_message_strobe_0 = blocks.message_strobe(pmt.intern("If you can risk all your winnings on one pitch and toss..."), 1000)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, 'D:\\Gnu_Simulations\\Lora\\dbsnr.cf32', False)
    ...
    def set_SNRdB(self, SNRdB):
        self.SNRdB = SNRdB
        self.channels_channel_model_0.set_noise_voltage((30**(-self.SNRdB/20)))




def main(top_block_cls=LoRa_Transciever, options=None):
